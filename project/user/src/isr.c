...
void PIT_IRQHandler(void)
{
    ...
    if(pit_flag_get(PIT_CH2))
    {
        ...
        Encoder_Get(); //获取当前速度
        // Upcomputer_Send(motor_zuoqian.speed, motor_youqian.speed, motor_zuohou.speed, motor_youhou.speed);
        // printf("%.1f, %.1f, %.1f, %.1f\n", motor_zuoqian.speed, motor_youqian.speed, motor_zuohou.speed, motor_youhou.speed);
    }
