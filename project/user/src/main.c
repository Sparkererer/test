...
//    pwm_set_duty(MOTORRF_PWM, 5000);
    ...
    while(1)
    {
        ...
        if (MotorBegin_Flag == 0)
        {
            ...
            // tft180_show_int(110, 80, angle, 3);
        }
        if(mt9v03x_finish_flag)
        {
            mt9v03x_finish_flag=0;
            // Turn_Bin(156);
            // tft180_show_gray_image_nitoushi(0, 0, ImageUsed, RESULT_W, RESULT_H, TFTSHOW_W, TFTSHOW_H, 0);
            // tft180_show_gray_image(0, 0, image_0[0], RESULT_W, RESULT_H, TFTSHOW_W, TFTSHOW_H, 0);
            // tft180_show_gray_image(0, 0, mt9v03x_image, MT9V03X_W, MT9V03X_H, TFTSHOW_W, TFTSHOW_H, 0);
            image_process();
            if (MotorBegin_Flag == 0) imageparam_show();
        }
    }
}
