...
{
	LADRC_TYPE1->h= LADRC_Unit[0][0]; //定时时间及时间步长
    LADRC_TYPE1->r =LADRC_Unit[0][1]; //跟踪速度参数
    LADRC_TYPE1->wc=LADRC_Unit[0][2]; //观测器带宽
    LADRC_TYPE1->w0=LADRC_Unit[0][3]; //状态误差反馈率带宽
	LADRC_TYPE1->b0=LADRC_Unit[0][4]; //系统参数
}
/**
  * 函数说明：LADRC全部初始化
  * 		WangShun于2022-07-03创建
