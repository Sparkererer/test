...
#define WIFI_UART_RX_PIN        (UART1_TX_B12)                                  // 连接 WIFI 模块 RX
#define WIFI_UART_TX_PIN        (UART1_RX_B13)                                  // 连接 WIFI 模块 TX
#define WIFI_UART_BAUD          (115200)                                        // 模块工作波特率
  
#define WIFI_UART_RTS_PIN       (B29)                                           // 定义流控位引脚  指示当前模块是否可以接受数据  0-可以继续接收  1-不可以继续接收
